    ...
    return (
        ...
        <div class = "rush-container">
            ...
            <div class = "rush-text">
                ...
                <br></br>
                <p>
                Come rush for Theta Tau! We're the only Co-ed Professional Engineering Fraternity at UCR. Theta Tau can help you in expanding your professional network, becoming a part of a brotherhood, giving back to the community, and becoming a better engineer.
                <br></br> <br></br>
                ...
                <div class = "rush-buttons">
                    <a href="https://forms.gle/K8tom1dVxWma7MA77" target = "_blank" rel = "noopener noreferrer">
                        <button class = "rush-bttn"><span>Interest Form</span></button>
                    </a>
                    <a href="https://discord.gg/fC4up6cbSS" target = "_blank" rel = "noopener noreferrer">
                        <button class = "rush-bttn"><span>Discord Link</span></button>
                    </a>
                </div>
            </div>
            <div>
